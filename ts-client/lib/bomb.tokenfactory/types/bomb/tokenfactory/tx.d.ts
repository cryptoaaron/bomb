...
export declare const protobufPackage = "bomb.tokenfactory";
...
export declare const MsgDeleteDenom: {
    encode(message: MsgDeleteDenom, writer?: _m0.Writer): _m0.Writer;
    ...
    create<I extends {
        ...
        owner?: string;
        denom?: string;
    } & { [K in Exclude<keyof I, keyof MsgDeleteDenom>]: never; }>(base?: I): MsgDeleteDenom;
    fromPartial<I_1 extends {
        owner?: string;
        denom?: string;
    } & {
        owner?: string;
        denom?: string;
    } & { [K_1 in Exclude<keyof I_1, keyof MsgDeleteDenom>]: never; }>(object: I_1): MsgDeleteDenom;
};
export declare const MsgDeleteDenomResponse: {
    encode(_: MsgDeleteDenomResponse, writer?: _m0.Writer): _m0.Writer;
    ...
    create<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(base?: I): MsgDeleteDenomResponse;
    fromPartial<I_1 extends {} & {} & { [K_1 in Exclude<keyof I_1, never>]: never; }>(_: I_1): MsgDeleteDenomResponse;
};
...
export declare const MsgServiceName = "bomb.tokenfactory.Msg";
