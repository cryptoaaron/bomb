...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "bm" }) => {
	...
	return {
		...
		async sendParams({ value, fee, memo }: sendParamsParams): Promise<DeliverTxResponse> {
			...
			try {
				...
				const signingClient = await SigningStargateClient.connectWithSigner(addr, signer, { registry: registry as any });
