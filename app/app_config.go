...
import (
	...
	tokenfactorymodulev1 "bomb/api/bomb/tokenfactory/module"
	_ "bomb/x/tokenfactory/module" // import for side-effects
	tokenfactorymoduletypes "bomb/x/tokenfactory/types"
