...
func init() {
	...
	md_Denom = File_bomb_tokenfactory_denom_proto.Messages().ByName("Denom")
...
func (x *Denom) slowProtoReflect() protoreflect.Message {
	mi := &file_bomb_tokenfactory_denom_proto_msgTypes[0]
...
func (x *fastReflection_Denom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "bomb.tokenfactory.Denom.denom":
		return x.Denom != ""
	case "bomb.tokenfactory.Denom.description":
		return x.Description != ""
	case "bomb.tokenfactory.Denom.ticker":
		return x.Ticker != ""
	case "bomb.tokenfactory.Denom.precision":
		return x.Precision != int32(0)
	case "bomb.tokenfactory.Denom.url":
		return x.Url != ""
	case "bomb.tokenfactory.Denom.maxSupply":
		return x.MaxSupply != int32(0)
	case "bomb.tokenfactory.Denom.supply":
		return x.Supply != int32(0)
	case "bomb.tokenfactory.Denom.canChangeMaxSupply":
		return x.CanChangeMaxSupply != false
	case "bomb.tokenfactory.Denom.owner":
		return x.Owner != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bomb.tokenfactory.Denom"))
		}
		panic(fmt.Errorf("message bomb.tokenfactory.Denom does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Denom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message bomb.tokenfactory.Denom does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Denom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "bomb.tokenfactory.Denom.denom":
		panic(fmt.Errorf("field denom of message bomb.tokenfactory.Denom is not mutable"))
	case "bomb.tokenfactory.Denom.description":
		panic(fmt.Errorf("field description of message bomb.tokenfactory.Denom is not mutable"))
	case "bomb.tokenfactory.Denom.ticker":
		panic(fmt.Errorf("field ticker of message bomb.tokenfactory.Denom is not mutable"))
	case "bomb.tokenfactory.Denom.precision":
		panic(fmt.Errorf("field precision of message bomb.tokenfactory.Denom is not mutable"))
	case "bomb.tokenfactory.Denom.url":
		panic(fmt.Errorf("field url of message bomb.tokenfactory.Denom is not mutable"))
	case "bomb.tokenfactory.Denom.maxSupply":
		panic(fmt.Errorf("field maxSupply of message bomb.tokenfactory.Denom is not mutable"))
	case "bomb.tokenfactory.Denom.supply":
		panic(fmt.Errorf("field supply of message bomb.tokenfactory.Denom is not mutable"))
	case "bomb.tokenfactory.Denom.canChangeMaxSupply":
		panic(fmt.Errorf("field canChangeMaxSupply of message bomb.tokenfactory.Denom is not mutable"))
	case "bomb.tokenfactory.Denom.owner":
		panic(fmt.Errorf("field owner of message bomb.tokenfactory.Denom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bomb.tokenfactory.Denom"))
		}
...
func (x *fastReflection_Denom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in bomb.tokenfactory.Denom", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: bomb/tokenfactory/denom.proto
...
func (*Denom) Descriptor() ([]byte, []int) {
	return file_bomb_tokenfactory_denom_proto_rawDescGZIP(), []int{0}
}
...
var File_bomb_tokenfactory_denom_proto protoreflect.FileDescriptor

var file_bomb_tokenfactory_denom_proto_rawDesc = []byte{
	...
	0x70, 0x69, 0x2f, 0x62, 0x6f, 0x6d, 0x62, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61, 0x63,
	0x74, 0x6f, 0x72, 0x79, 0xa2, 0x02, 0x03, 0x42, 0x54, 0x58, 0xaa, 0x02, 0x11, 0x42, 0x6f, 0x6d,
	0x62, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0xca, 0x02,
	0x11, 0x42, 0x6f, 0x6d, 0x62, 0x5c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x66, 0x61, 0x63, 0x74, 0x6f,
	0x72, 0x79, 0xe2, 0x02, 0x1d, 0x42, 0x6f, 0x6d, 0x62, 0x5c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x66,
	0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0xea, 0x02, 0x12, 0x42, 0x6f, 0x6d, 0x62, 0x3a, 0x3a, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_bomb_tokenfactory_denom_proto_rawDescOnce sync.Once
	file_bomb_tokenfactory_denom_proto_rawDescData = file_bomb_tokenfactory_denom_proto_rawDesc
)

func file_bomb_tokenfactory_denom_proto_rawDescGZIP() []byte {
	file_bomb_tokenfactory_denom_proto_rawDescOnce.Do(func() {
		file_bomb_tokenfactory_denom_proto_rawDescData = protoimpl.X.CompressGZIP(file_bomb_tokenfactory_denom_proto_rawDescData)
	})
	return file_bomb_tokenfactory_denom_proto_rawDescData
}

var file_bomb_tokenfactory_denom_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_bomb_tokenfactory_denom_proto_goTypes = []interface{}{
	(*Denom)(nil), // 0: bomb.tokenfactory.Denom
}
var file_bomb_tokenfactory_denom_proto_depIdxs = []int32{
...
func init() { file_bomb_tokenfactory_denom_proto_init() }
func file_bomb_tokenfactory_denom_proto_init() {
	if File_bomb_tokenfactory_denom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_bomb_tokenfactory_denom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Denom); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_bomb_tokenfactory_denom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_bomb_tokenfactory_denom_proto_goTypes,
		DependencyIndexes: file_bomb_tokenfactory_denom_proto_depIdxs,
		MessageInfos:      file_bomb_tokenfactory_denom_proto_msgTypes,
	}.Build()
	File_bomb_tokenfactory_denom_proto = out.File
	file_bomb_tokenfactory_denom_proto_rawDesc = nil
	file_bomb_tokenfactory_denom_proto_goTypes = nil
	file_bomb_tokenfactory_denom_proto_depIdxs = nil
}
