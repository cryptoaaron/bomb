...
export { Deposit, MsgVote, TallyResult, QueryProposalResponse, QueryProposalsResponse, MsgSubmitProposalResponse, GenesisState, Proposal, TallyParams, QueryVotesRequest, QueryVotesResponse, QueryDepositRequest, QueryDepositResponse, QueryDepositsRequest, DepositParams, QueryProposalsRequest, QueryVoteResponse, QueryParamsResponse, QueryDepositsResponse, QueryTallyResultResponse, VotingParams, MsgSubmitProposal, QueryTallyResultRequest, MsgVoteWeighted, MsgVoteWeightedResponse, MsgDeposit, MsgDepositResponse, MsgVoteResponse, WeightedVoteOption, TextProposal, Vote, QueryProposalRequest, QueryVoteRequest, QueryParamsRequest };
