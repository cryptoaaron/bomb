...
const (
	Query_Params_FullMethodName   = "/bomb.tokenfactory.Query/Params"
	Query_Denom_FullMethodName    = "/bomb.tokenfactory.Query/Denom"
	Query_DenomAll_FullMethodName = "/bomb.tokenfactory.Query/DenomAll"
)
