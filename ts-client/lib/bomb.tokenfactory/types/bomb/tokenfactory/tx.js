...
export const protobufPackage = "bomb.tokenfactory";
...
function createBaseMsgDeleteDenom() {
    return { owner: "", denom: "" };
}
export const MsgDeleteDenom = {
    ...
    create(base) {
        return MsgDeleteDenom.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseMsgDeleteDenom();
        message.owner = object.owner ?? "";
...
function createBaseMsgDeleteDenomResponse() {
    return {};
}
export const MsgDeleteDenomResponse = {
    ...
    create(base) {
        return MsgDeleteDenomResponse.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseMsgDeleteDenomResponse();
        return message;
...
export const MsgServiceName = "bomb.tokenfactory.Msg";
